...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/title/this-is-my-title')); ?>"
            ...
            <div class="list-group list-group-numbered mt-4">
                ...
                list-group-item-action">
                    Admin Users
            </a ><a href="<?php echo e(route('admin.items')); ?>"
                    class="list-group-item
                list-group-item-action">
                Admin Items
                </a>
...
<?php /**PATH E:\SI FRAMEWORK\Part 2\project-canggih-dedi-setiadi\resources\views/routing.blade.php ENDPATH**/ ?>